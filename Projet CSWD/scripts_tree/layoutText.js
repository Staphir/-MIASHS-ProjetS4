...
function layoutText(textNode, text, width, x, height, dy, rectId) {
    var namespace = "http://www.w3.org/2000/svg";
    var previousFit = "";
    var tspan = document.createElementNS(namespace, "tspan");
    tspan.setAttributeNS(null, "x", x);
    tspan.setAttribute("id", rectId);
    tspan.addEventListener("click", rectonclick);
    ...
    firstTspan.setAttribute("id", rectId);
    firstTspan.addEventListener("click", rectonclick);
}
